...
import TimeEntryApp from "../../microapps/timeEntryApp/Index";
import ClassApp from "../../microapps/classApp/Index";
...
export default function EmployeeModule() {
  ...
  const getAppNavigationCenter = async () => {
    const response = await ApiService.get(
      "appNavigationCenter/query?navigationCenterId=nav_employee"
    );
    ...
    <AppContainer>
      ...
      <AppContentContainer>
        <Routes>
          ...
          <Route path="/timeentry*" element={<TimeEntryApp />} />
          <Route path="/classes*" element={<ClassApp />} />
        </Routes>
      </AppContentContainer>
    </AppContainer>
