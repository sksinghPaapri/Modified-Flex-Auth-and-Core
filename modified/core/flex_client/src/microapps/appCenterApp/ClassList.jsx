...
export default function ClassList() {
  ...
  const columns = [
      ...
      cellRenderer: (params) => (
        <>
          <Button
            ...
            size="sm"
            as={Link}
            to={`/${rootPath}/${_config.appRoutes.baseUrl}/edit/${params.value}`}
          >
            <BsBoxArrowInUpRight />
          </Button>
    ...
    { headerName: "ICONNAME", field: "iconName" },
  ];
            ...
            <Col className="p-0 ps-2">
              ...
              >
                <Breadcrumb.Item active>
                  {" "}
                  <div className="breadcrum-label-active">
                    {_config.appName}
                  </div>
                </Breadcrumb.Item>
          ...
          <Row style={{ marginTop: "-10px" }}>
            <Col className="p-0 ps-1">
              <Button
                size="sm"
                as={Link}
                to={`/${rootPath}/${_config.appRoutes.baseUrl}/add`}
              >
                CREATE
              </Button>{" "}
            </Col>
