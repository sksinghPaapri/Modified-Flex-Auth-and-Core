...
export default function Employee() {
  ...
  const createDocument = (data) => {
    ...
    return ApiService.post("/employee", data)
      ...
      .catch((e) => {
        console.log("e in createEmployee", e.response?.data.message);
        errorMessage(e, null);
      });
  };
  ...
  const updateDocument = (id, data) => {
    ApiService.setHeader();
    return ApiService.patch(`/employee/${id}`, data)
      .then((response) => {
      ...
      .catch((e) => {
        console.log("e in updateEmployee", e.response?.data.message);
            ...
            <Col className="p-0 ps-2">
              ...
              >
                <Breadcrumb.Item
                  ...
                  linkAs={Link}
                  linkProps={{ to: `/${rootPath}/employees/list` }}
                >
                  {" "}
                  <div className="breadcrum-label">EMPLOYEES</div>
                </Breadcrumb.Item>
                {isAddMode ? (
